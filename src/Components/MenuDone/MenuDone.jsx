    ...
    return <div className={style.container}>
        ...
        <div className={style.doneList}>
            ...
            <div className={style.menu}>
               ...
               {todos.map(({ title, _id, time, category, difficulty, challenge, done }) => (
             <li key={_id} ><DashboardListItem category={category} difficulty={difficulty} title={title} done={done} id={_id} time={time} challengeStyle={challenge}>
